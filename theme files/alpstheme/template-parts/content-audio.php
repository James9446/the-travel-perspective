...
<article id="post-<?php the_ID(); ?>" <?php post_class(''); ?> data-aos="fade-up" data-aos-anchor-placement="center-bottom"  >
	<header class="entry-header">
		...
		<iframe height="450" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/<?php echo get_field('audio_url'); ?>&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe>
        </div>
		...
		?>
            ...
            <div class="post-image">
            <iframe height="450" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/<?php echo esc_url(get_field('audio_url')); ?>&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe>
            </div>
		...
		?>
            <div class="entry-content">
				...
				?>
            <div class="readmore fancy"><a href="<?php echo get_permalink() ?>"><span><?php echo esc_html__('CONTINUE READING', 'alpstheme') ?></span></a></div>
            </div>
        <?php
		endif;
		?>
